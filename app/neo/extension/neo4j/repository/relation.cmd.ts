...
async function testRelationRepositories() {
  ...
  try {
    ...
    console.log("✅ Saved definition:", savedDefinition.id);
    console.log(
    ...
    console.log("\n🔍 FINDING RELATION DEFINITION BY TYPE:");
    // Use relationDefRepo
    ...
    console.log("\n🔍 FINDING RELATION DEFINITION BY TAG:");
    // Use relationDefRepo
    ...
    console.log("✅ Updated definition:", JSON.stringify(updatedDef, null, 2));
    ...
    try {
      ...
      console.log(
        "✅ Created/Merged test entities with IDs:",
        sourceId,
        targetId
      );
    } finally {
    ...
    console.log("\n🔗 CREATING RELATION INSTANCE (using createRelation):");
    const instanceData = {
    ...
    console.log("\n🔍 FINDING INSTANCES BY DEFINITION ID:");
    // Use relationShapeRepo
    ...
    console.log("\n🔍 FINDING INSTANCES BY SOURCE ID:");
    // Use relationShapeRepo
    ...
    console.log("\n🔍 GETTING ENTITY RELATIONS (outgoing from source):");
    // Use relationShapeRepo
    ...
    console.log("\n🔍 FINDING CONNECTED ENTITIES (outgoing from source):");
    // Use relationShapeRepo
    ...
    try {
      console.log("\n🗑️ TRYING TO DELETE RELATION DEFINITION (force=false):");
      await relationDefRepo.deleteRelationDefinition(definitionId, false);
      console.log("❌ Definition deleted without force (unexpected).");
    } catch (error: any) {
      console.log(
        "✅ Correctly failed to delete definition without force:",
        error.message
      );
    }

    // Now delete with force=true
    console.log("\n🗑️ DELETING RELATION DEFINITION (force=true):");
    // Use relationDefRepo
    ...
    console.log(
      definitionDeleted
        ? "✅ Definition deleted successfully with force."
        : "❌ Definition deletion failed with force."
    );

    // 3.3 Delete test entities
    console.log("\n🗑️ DELETING TEST ENTITIES:");
    ...
    console.log("\n🎉 All Relation Repository tests completed successfully!");
  } catch (error) {
    console.error("\n❌ ERROR DURING RELATION REPOSITORY TEST:", error);
  } finally {
    if (connection) {
      console.log("\nClosing connection...");
