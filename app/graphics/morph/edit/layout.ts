...
import { FormShape, FormSection } from "../../schema/form";
...
export const EditSectionLayoutMorph = createMorph<EditOutput, EditOutput>(
  ...
  (shape, context) => {
    ...
    if (!shape.layout?.sections || shape.layout.sections.length === 0) return shape;
...
export const EditLayoutPipeline = createPipeline<EditOutput, EditOutput>("EditLayoutPipeline")
