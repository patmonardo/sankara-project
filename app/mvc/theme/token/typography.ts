...
// Typography style compositions schema - adding the new styles needed for StatCard
export const typographySchema = z.object({
  ...
  // New styles needed for StatCard and other components
...
const typographyValues = {
  ...
  button: `text-sm font-medium leading-none uppercase tracking-wide`,
  overline: `text-xs font-medium leading-none uppercase tracking-widest`,
