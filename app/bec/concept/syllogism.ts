...
export function createDisjunctiveSyllogism(
  ...
  const conclusion: Conclusion = {
    ...
    necessity:// filepath: /home/pat/VSCode/sankara/app/bec/concept/syllogism.ts
import { NeoNode, createNeoNode } from '../../neo/node';
import { NeoEntityId } from '../../neo/dialectic';
import { Judgment } from './judgment';
import { Concept } from './concept';
  ...
  createSyllogism(
    ...
    if (type === 'existence') {
      ...
      if (subtype === 'categorical') {
        ...
        const options = terms.slice(1, terms.length - 1);
        syllogism = createDisjunctiveSyllogism(subject, options, actualOption, options);
      }
    }
